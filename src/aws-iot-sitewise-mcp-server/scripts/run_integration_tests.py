...
def main():
    ...
    parser.add_argument(
        '--test', help='Specific test class to run (e.g., TestAssetModelLifecycle)'
    )
    parser.add_argument(
        '--region', default='us-east-1', help='AWS region for testing (default: us-east-1)'
    )
    parser.add_argument('--dry-run', action='store_true', help='Check setup without running tests')
